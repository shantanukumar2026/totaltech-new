    ...
    <section id="section-who-we-are" className="w-full bg-white py-10 sm:py-14 border-t border-[#E2E8F0] select-none">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center pb-8 mb-8 border-b border-[#E2E8F0]">
          ...
          <div className="lg:col-span-5 bg-[#F8FBFE] border border-[#D2E4F9] p-4 sm:p-5 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {CAPABILITIES.map((item, idx) => {
            ...
            return (
              ...
              >
                <div>
                  <div className="w-9 h-9 bg-white border border-[#D2E4F9] flex items-center justify-center text-[#0055FF] mb-3.5 group-hover:bg-[#0055FF] group-hover:text-white transition-colors">
                ...
                <div className="pt-3.5 mt-3.5 border-t border-[#E2E8F0] flex items-center justify-between text-[11px] font-mono font-bold text-slate-400 group-hover:text-[#0055FF] transition-colors">
