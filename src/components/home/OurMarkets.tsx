  ...
  const PILLARS = [
    {
      ...
      desc: "Engineering precast and prestressed concrete systems for bridges, overpasses, interchanges, highway structures, barriers, and other transportation infrastructure. Our solutions address structural performance, constructability, durability, detailing, and efficient field installation.",
    },
    {
      icon: Compass,
      title: "Rail Infrastructure & Transit Systems",
      desc: "Engineering precast structural systems for rail, metro, light rail, and transit infrastructure. We support elevated guideways, viaducts, stations, structural components, and related systems through detailed engineering, BIM coordination, fabrication documentation, and erection planning.",
    },
    {
      icon: Building2,
      title: "Industrial & Manufacturing Facilities",
      desc: "Providing engineered precast structural solutions for industrial facilities, manufacturing plants, logistics operations, and large-scale production environments. Our approach integrates structural design, precast detailing, manufacturing requirements, and constructability.",
    },
  ];
